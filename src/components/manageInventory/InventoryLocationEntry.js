...
class InventoryLocationEntry extends React.Component {
  ...
  render() {
    return this.props.itemInLocation ? (
      <div className={`${this.props.itemId} inventory-item`}>
        <div className="manage-item-image">
          <img
            src={
              this.props.itemInLocation.images
                ? this.props.itemInLocation.images[0]
        ...
        <div className="manage-item-itemedit">
          <p onClick={() => this.props.deleteItem(this.props.itemId)} type="button">
            x
          </p>
          <Link to={'/addItems/'}>
            <p
